...
> **New to my extensions?** Start with **Character Visuals** → enable **Outfit Lab** for multi-character wardrobe control → consult the Character Expressions README for emotion swaps. Return here only if you need the archival Outfit Switcher drawer or a minimal install.
